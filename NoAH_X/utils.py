...
def prep_dataset_wo_attr(data_name):
    ...
    """
        ...
        Read hypergraph infomation from hyperedge.txt and return hyperedges, number of nodes, and number of hyperedges.
    """
    ...
    return hyperedges, num_nodes, num_edges
